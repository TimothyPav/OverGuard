...
var _ashePng = require("../assets/images/ashe.png");
var _ashePngDefault = parcelHelpers.interopDefault(_ashePng);
var _cassidyPng = require("../assets/images/cassidy.png");
var _cassidyPngDefault = parcelHelpers.interopDefault(_cassidyPng);
var _hanzoPng = require("../assets/images/hanzo.png");
var _hanzoPngDefault = parcelHelpers.interopDefault(_hanzoPng);
var _sojournPng = require("../assets/images/sojourn.png");
var _sojournPngDefault = parcelHelpers.interopDefault(_sojournPng);
var _soldier76Png = require("../assets/images/soldier76.png");
var _soldier76PngDefault = parcelHelpers.interopDefault(_soldier76Png);
var _tracerPng = require("../assets/images/tracer.png");
...
const heroImages = {
    ...
    hanzo: (0, _hanzoPngDefault.default),
    sojourn: (0, _sojournPngDefault.default),
    soldier76: (0, _soldier76PngDefault.default),
    tracer: (0, _tracerPngDefault.default),
...
},{"./charts":"kkiZQ","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","../assets/images/cassidy.png":"5BDRh","../assets/images/hanzo.png":"doK9N","../assets/images/sojourn.png":"8KdUz","../assets/images/soldier76.png":"5jwZT","../assets/images/tracer.png":"mfrqX","../assets/images/widowmaker.png":"c3cYE","../assets/images/ashe.png":"jMbK8","./hero_objects.js":"4ZNgc","./api.js":"8Zgej"}],"kkiZQ":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "fetch_data_and_create_scatter_plot", ()=>fetch_data_and_create_scatter_plot);
parcelHelpers.export(exports, "fetch_data_and_create_bar_chart", ()=>fetch_data_and_create_bar_chart);
parcelHelpers.export(exports, "updateAllCharts", ()=>updateAllCharts);
...
async function fetch_data_and_create_scatter_plot(id, heroName, columnDataX, columnDataY, color) {
    try {
        const [xResponse, yResponse] = await Promise.all([
            (0, _apiJs.get_hero_stat)(heroName, columnDataX),
            (0, _apiJs.get_hero_stat)(heroName, columnDataY)
        ]);
...
function createChart(id, data, columnDataX, columnDataY, color) {
    ...
    chartInstances[id] = new (0, _autoDefault.default)(ctx, {
        type: "scatter",
        data: {
            datasets: [
                {
...
async function fetch_data_and_create_bar_chart(id, hero_name, columnDataY, color) {
    try {
...
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "get_hero_stat", ()=>get_hero_stat);
parcelHelpers.export(exports, "get_player_stat", ()=>get_player_stat);
var _axios = require("axios");
var _axiosDefault = parcelHelpers.interopDefault(_axios);
async function get_hero_stat(heroName, columnData) {
    try {
        const response = await (0, _axiosDefault.default).get("http://0.0.0.0:3000/api/hero_stat", {
            params: {
                hero_name: heroName,
                column: columnData
            }
...
let warning_notif = document.getElementById("playtime");
async function get_player_stat(btag) {
    try {
        const response = await (0, _axiosDefault.default).get("http://0.0.0.0:3000/api/player", {
            params: {
                battletag: btag
            }
        });
...
parcelHelpers.export(exports, "ashe", ()=>ashe);
parcelHelpers.export(exports, "cassidy", ()=>cassidy);
parcelHelpers.export(exports, "hanzo", ()=>hanzo);
parcelHelpers.export(exports, "sojourn", ()=>sojourn);
parcelHelpers.export(exports, "soldier76", ()=>soldier76);
parcelHelpers.export(exports, "tracer", ()=>tracer);
parcelHelpers.export(exports, "heroes", ()=>heroes);
const widowmaker = {
    0: [
        "Scoped Accuracy",
    ...
    1: [
        "Scoped Crit Hits per 10 mins",
        "Scoped Crit Kills per 10 mins"
    ],
    2: [
        "Solo Kills per 10 mins",
        "Final Blows per 10 mins"
    ],
    3: [
        "Hero Damage Done per 10 mins",
        "Deaths per 10 mins"
    ],
    name: "widowmaker",
    len: 4,
...
const cassidy = {
    0: [
        "Critical Hits per 10 mins",
        "Critical Hit kills per 10 mins"
    ],
    1: [
        "Solo Kills per 10 mins",
        "Final Blows per 10 mins"
...
const sojourn = {
    ...
    3: [
        "Charged Shot Kills per 10 mins"
    ],
    name: "sojourn",
    len: 4,
    color: "#FF565080"
